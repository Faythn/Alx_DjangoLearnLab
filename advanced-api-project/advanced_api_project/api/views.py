...
"""
This file defines generic views for CRUD operations on the Book model.
Permissions:
- ListView & DetailView: Read-only, accessible to all (AllowAny).
